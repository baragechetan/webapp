		...
		stage ('Depoly_on_dev') {
            ...
            steps {       
				sshagent(['deploy-user']) {
							...
							sh 'ssh dev@34.221.107.99 sudo rm -rf /mnt/project/dockerimgs/*'
							sh 'ssh dev@34.221.107.99 sudo git clone https://github.com/baragechetan/dockerimgs.git /mnt/project/dockerimgs'
